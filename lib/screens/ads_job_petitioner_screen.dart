...
import 'package:jobit_mobile_app/services/ad_probando_service.dart';
      ...
      body: Column(children: <Widget>[
        ...
        Expanded(
            child: SizedBox(
                ...
                child: Expanded(
                  child: FutureBuilder(
                    future: AdServiceProbando.getAllAds(),
                                              ...
                                              SizedBox(
                                                  ...
                                                  child: Expanded(
                                                      child: TextButton(
                                                        ...
                                                        //      MaterialPageRoute(
                                                        //          builder: (context) =>
                                                        //              detailJobAd(adJob.postJobTitle.toString(), adJob.description.toString())));
                                                        },
                                                      ))),
                                              SizedBox(
                                                  width: 230,
                                              ...
                                              Row(
                                                children: <Widget>[
                                                  TextButton(
                                                      ...
                                                      //      MaterialPageRoute(
                                                      //          builder: (context) =>
                                                      //              updateAdJob(adJob.postJobTitle.toString(), adJob.description.toString(), adJob.salary.toString(), adJob.postJobId.toString())));
                                                      },
                                                      child: Text(
                                                        'Edit',
                                                        style: TextStyle(
                                                  ...
                                                  TextButton(
                                                      ...
                                                      //      return deleteConfirm(adJob.postJobId.toString());
                                                      //    },
                                                      //  );
                                                      },
                                                      child: Text(
